      ...
      <div class="profile-container">
        <div class="profile-box">
          ...
          <div class="profile-info">
            ...
            <div class="profile-role">账号身份: 管理员</div>
            <div class="profile-id">账号ID: 000001</div>
            <div class="profile-balance">钱包余额: 666666 元</div>
            <div class="profile-games">
              <router-link to="/MyGamesAd">我的游戏</router-link>
            </div>
            <div class="profile-exit">
              <router-link to="/UserLogin">退出</router-link>
            </div>
          </div>
        </div>
      </div>
