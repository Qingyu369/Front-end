<template>
  <div class="home-page">
    ...
    <div class="sale-title-container">
      ...
      <div class="sale-title-part2">冬季特卖！！！</div>
    </div>
    <div class="sale-title-part3">即日起至2025年12月12日</div>
    <!-- 游戏列表部分 -->
        ...
        >
          ...
          <div class="game-info">
            ...
            <div class="game-actions">
              ...
              <button class="buy-button" @click="addToCart(game)">加入购物车</button>
            </div>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    addToCart(game) {
      if (confirm('确定要将该游戏加入购物车吗？')) {
        // 将游戏信息添加到购物车
        this.$store.commit('addGameToCart', game);
      }
    },
  }
};
